...
describe('utils', () => {
  it('correctly decodes streamed utf8 chunks in complex mode', () => {
    ...
    enqueuedChunks.push(encoder.encode(getStreamString('text', normalDecode(chunk1))));
    enqueuedChunks.push(encoder.encode(getStreamString('text', normalDecode(chunk2))));
