...
describe('utils', () => {
  it('correctly decodes streamed utf8 chunks in complex mode', () => {
    const normalDecode = (0, _utils.createChunkDecoder)();
    const complexDecode = (0, _utils.createChunkDecoder)(true);
    ...
    enqueuedChunks.push(encoder.encode((0, _utils.getStreamString)('text', normalDecode(chunk1))));
    enqueuedChunks.push(encoder.encode((0, _utils.getStreamString)('text', normalDecode(chunk2))));
  ...
  it('correctly decodes streamed utf8 chunks in simple mode', () => {
    const decoder = (0, _utils.createChunkDecoder)(false);
    const encoder = new TextEncoder();
